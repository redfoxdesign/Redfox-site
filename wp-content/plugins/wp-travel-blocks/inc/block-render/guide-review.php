    ...
    <p class="wptravel-guide-review-block wptravel-tourguide-aside-review">
        <?php if( $guide_data ) :?>
            <?php if ( wp_travel_travel_guide_rating( get_the_ID() )['review_count'] < 1 ) : ?>
                    <span class="wp-travel-noreviews"><?php echo __( 'No review yet. Be first to give review', 'wp-travel-pro' ); ?></span>
                <?php
                else :
                    ...
                    <span><?php echo esc_html( wp_travel_travel_guide_rating()['review_count'] ); ?><?php echo __( ' reviews', 'wp-travel-pro' ); ?></span>
            <?php } endif; ?>
            <?php else: ?>
                ...
                <span><?php echo __( '2 reviews', 'wp-travel-pro' ); ?></span>
        <?php } endif; ?>
    </p>
    <style>
