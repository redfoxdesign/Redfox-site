...
function wptravel_block_guide_review_form_render( $attributes ) {
    ...
    <div id="wptravel-travel-guide-Review" class="wptravel-guide-review-form-block wptravel-travel-guide-Review">
        <?php if( $guide_data ) :?>
            <h3 class="section-title"> <?php echo __( 'RECENT REVIEW', 'wp-travel-pro' ); ?></h3>
			<?php comments_template(); ?>
            <?php else: 
                echo __( 'Guide review form block only visible in frontend.', 'wp-travel-pro' );    
        endif; ?>
    </div>
    <style>
