...
?>
			...
			<div id="wptravel-block-trips-list" class="wptravel-block-wrapper wptravel-block-trips-list wptravel-block-preview <?php echo $layout_type . ' ' . 'block-id-' . hash('sha256', json_encode($attributes)); ?>">
											...
											<div class="wptravel-blocks-card-body">
												...
												<div class="wptravel-blocks-card-footer">
													...
													<div class="wptravel-blocks-footer-right">
														<div class="wptravel-blocks-trip-explore">
															<a href="<?php echo esc_url($trip_url); ?>">
																<button class="wp-block-button__link wptravel-blocks-explore-btn"><?php echo __('Explore', 'wp-travel-blocks') ?></button>
															</a>
														</div>
													</div>
												</div>
		...
		<?php
			...
			<div id="wptravel-block-trips-list" class="wptravel-block-wrapper wptravel-block-trips-list wptravel-block-preview <?php echo $layout_type . ' ' . 'block-id-' . hash('sha256', json_encode($attributes)); ?>">
				<div class="wp-travel-itinerary-items">
					...
					if ($query->have_posts()) { ?>
						<div class="wp-travel-itinerary-items wptravel-archive-wrapper  <?php echo $layout_type == 'default-layout' ? 'grid-view' : $card_layout; ?> <?php echo $slider_enable; ?>">
